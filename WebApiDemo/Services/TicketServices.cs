...
namespace WebApiDemo.Services
{
    public class TicketServices
    {
        ...
        //public static object TicketServices { get; internal set; }

        static TicketServices()
        {
            Tickets = new List<Ticket>
                {
                      new Ticket {ID=1, BookedFor="Platinum Plus",Price=5000,Qty=20 },
                      new Ticket {ID=2, BookedFor = "Platinum ", Price = 4000, Qty = 300 },
                      new Ticket {ID=3, BookedFor="Gold",Price=3000,Qty=500 },
                      new Ticket {ID=4, BookedFor="Platinum Plus",Price=2000,Qty=50 },
                      new Ticket {ID=5, BookedFor="Platinum Plus",Price=800,Qty=10 }
                };
        }
